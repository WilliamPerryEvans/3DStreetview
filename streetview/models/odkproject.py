from sqlalchemy import Integer, ForeignKey, Column, event
...
odk_forms = ["streetview/static/forms/3DStreetView_main.xlsx", "streetview/static/forms/3DStreetView_fill.xlsx"]

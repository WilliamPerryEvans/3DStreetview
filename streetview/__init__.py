...
from streetview.models.user import User, Role
from streetview.views import admin

# Create flask streetview
...
def create_app(config_name):
    ...
    from streetview.controllers import odk_api
    from streetview.controllers import odm_api
    from streetview.controllers import odmproject_api
    from streetview.controllers import odkproject_api
    from streetview.controllers import mesh_api
...
def user_registered_sighandler(sender, **kwargs):
    if app.config["SECURITY_SEND_REGISTER_EMAIL"]:
        msg = Message(
            ...
            # sender=streetview.config["MAIL_DEFAULT_SENDER"],
